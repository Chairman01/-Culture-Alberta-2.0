        ...
        <aside className="my-10 rounded-2xl bg-gradient-to-r from-blue-700 to-blue-600 text-white px-6 py-6 sm:px-8 sm:py-7 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-6">
                ...
                <a
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-white text-gray-800 font-semibold px-5 py-3 rounded-xl shadow-sm hover:shadow-md transition-shadow flex-shrink-0"
                >
