/**
 * Restore Witch Perfect Event
 * 
 * This script adds the missing Witch Perfect event back to the data
 */
...
async function restoreWitchPerfectEvent() {
  try {
    console.log('🔄 Restoring Witch Perfect event...')
...
⚠️ Note: This show contains spoilers for Wicked: For Good, in theatres November 21st.`,
      ...
      capacity: 100,
      current_attendees: 0,
      image_url: '/images/witch-perfect-event.jpg',
      website_url: '#',
      facebook_url: '#',
      instagram_url: '#',
      twitter_url: '#',
      ...
      imageUrl: '/images/witch-perfect-event.jpg',
      trendingHome: false,
    ...
    articles.unshift(event)
    
    // Write back to file
    fs.writeFileSync(fallbackPath, JSON.stringify(articles, null, 2))
    
    console.log('✅ Successfully restored Witch Perfect event!')
    ...
    console.log('🔗 URL: /events/witch-perfect-for-good-a-wickedly-delicious-dining-experience-coming-to-calgary')
