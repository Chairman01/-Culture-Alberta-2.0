...
// reads) — so they use the service role rather than the public anon key.
...
// Types and the pure aggregation helpers live in ./newsletter-analytics so
// client components can import them without this module (and its service-role
// client) coming along.
export type {
  EmailEvent, CampaignStat, SubscriberEngagement,
  CampaignRecipient, CampaignDetails, NewsletterSubscription,
} from "./newsletter-analytics"
export {
