  ...
  useEffect(() => {
    async function loadEdmontonArticles() {
      try {
        ...
        const edmontonPosts = combinedPosts.filter(
                ...
                <Link href={`/articles/${featureArticle.id}`} className="group block">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-500">{featureArticle.created_at ? new Date(featureArticle.created_at).toLocaleDateString() : ""}</span>
                    </div>
