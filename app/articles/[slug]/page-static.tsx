...
import { getAllArticles, getArticleById } from '@/lib/supabase-articles'
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    return {
      ...
      description: article.excerpt || article.description || `Read about ${article.title} on Culture Alberta`,
      openGraph: {
        title: article.title,
    ...
    return {
      ...
      description: 'Read articles about Alberta culture, events, and experiences.',
    }
  }
}
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    const loadedArticle = article || await getArticleById(slug)
    ...
    const relatedArticles = [...sameCategory, ...otherArticles]
