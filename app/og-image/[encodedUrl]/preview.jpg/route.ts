...
import { proxySocialImageGet, proxySocialImageHead } from '@/app/api/og-image/_proxy'
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    console.error('Social image proxy error:', error)
...
export async function HEAD(_request: NextRequest, context: RouteContext) {
  try {
    ...
    console.error('Social image proxy HEAD error:', error)
