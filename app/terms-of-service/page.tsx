  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose max-w-none space-y-6">
        ...
        <p className="text-lg">
          Welcome to Culture Alberta. By accessing and using our website (culturealberta.com),
          you agree to comply with and be bound by the following terms and conditions.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">1. Acceptance of Terms</h2>
        <p className="mb-4">
          By accessing or using Culture Alberta, you acknowledge that you have read, understood,
          and agree to be bound by these Terms of Service and our Privacy Policy. If you do not
          agree with these terms, please do not use our website.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Use of Website</h2>
        <h3 className="text-xl font-semibold mt-6 mb-3">2.1 Permitted Use</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">2.2 User Accounts</h3>
        <p className="mb-4">
        ...
        <p className="mb-4">
          All content on Culture Alberta, including but not limited to text, images, graphics,
          logos, videos, and software, is the property of Culture Alberta or its content suppliers
        ...
        <p className="mb-4">
          If you submit content to our website (such as comments, reviews, or articles), you grant
          Culture Alberta a non-exclusive, royalty-free, perpetual, and worldwide license to use,
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Third-Party Links and Services</h2>
        <p className="mb-4">
          Our website may contain links to third-party websites and services. We are not responsible
          for the content, privacy practices, or terms of service of these third-party sites. Your
          use of third-party websites is at your own risk.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Advertising</h2>
        <p className="mb-4">
          We use Google AdSense to display advertisements on our website. Advertisers are solely
          responsible for the content of their advertisements. We do not endorse or guarantee any
          products or services advertised on our website.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">7. Disclaimer of Warranties</h2>
        <p className="mb-4">
          Culture Alberta is provided "as is" and "as available" without any warranties of any kind,
        ...
        <p className="mb-4">
          To the fullest extent permitted by law, Culture Alberta shall not be liable for any
          indirect, incidental, special, consequential, or punitive damages arising from your use
          of or inability to use the website, including but not limited to:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <p className="mb-4">
          You agree to indemnify, defend, and hold harmless Culture Alberta and its officers,
        ...
        <p className="mb-4">
          ...
          any changes by posting the updated terms on this page and updating the "Last updated" date.
        ...
        <p className="mb-4">
          ...
          without prior notice, for any reason, including but not limited to violation of these
          Terms of Service.
        </p>
        ...
        <p className="mb-4">
          ...
          of the Province of Alberta and the federal laws of Canada applicable therein, without
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-8">
          <p className="text-sm">
            <strong>Note:</strong> By using Culture Alberta, you acknowledge that you have read
