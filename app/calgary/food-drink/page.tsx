/**
 * Optimized Calgary Food & Drink Page
 * 
 ...
 * 
 * Used as: Calgary Food & Drink category page (/calgary/food-drink)
 */
...
import { getCityFoodDrinkArticles } from '@/lib/data/city-category-data'
...
/**
 * Calgary Food & Drink Page Component
 * 
 * Displays food & drink articles for Calgary
 */
export default async function CalgaryFoodDrinkPage() {
  const articles = await getCityFoodDrinkArticles('calgary')
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col">
        <main className="flex-1">
          {/* Header Section */}
          <section className="w-full py-6 bg-orange-50">
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="flex flex-col items-center justify-center space-y-2 text-center">
                <div className="space-y-1">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-orange-600">
                    Calgary Food & Drink
                  </h1>
                  <p className="max-w-[900px] text-muted-foreground md:text-xl mx-auto">
                    Discover {articles.length} articles about Calgary's vibrant food and drink scene.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="w-full py-8">
            <div className="container mx-auto px-4 md:px-6">
              {articles.length > 0 ? (
                ...
                <EmptyState 
                  icon="🍽️"
                  title="No Food & Drink Articles Found"
                  description="Check back later for new Calgary food and drink articles."
                />
              )}
            </div>
          </section>
      ...
      <article className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <div className="p-4">
          <div className="flex items-center gap-2 text-xs text-muted-foreground mb-2">
            <span className="rounded-full bg-orange-100 text-orange-800 px-2.5 py-0.5 text-xs font-semibold">
          ...
          <h3 className="font-bold text-lg group-hover:text-orange-600 transition-colors duration-300 line-clamp-2 leading-tight mb-2">
