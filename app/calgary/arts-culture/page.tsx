...
export default function CalgaryArtsCulturePage() {
  ...
  useEffect(() => {
    async function loadCalgaryArticles() {
      try {
        ...
        setArticles(artsCultureArticles)
      } catch (error) {
        console.error("Error loading Calgary arts & culture articles:", error)
      } finally {
        setIsLoading(false)
      }
    }
  ...
  return (
    <>
      ...
      />
      <PageTracker title="Calgary Arts & Culture Articles - Culture Alberta" />
            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="flex flex-col items-center justify-center space-y-2 text-center">
                <div className="space-y-1">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-purple-600">Calgary Arts & Culture</h1>
            ...
            <div className="container mx-auto px-4 md:px-6">
              {currentArticles.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="font-semibold text-lg mb-2">No Arts & Culture Articles Found</h3>
                  <p className="text-gray-600 text-sm">Check back later for new Calgary arts and culture articles.</p>
                </div>
              )}
            </div>
          </section>
