/**
 * Optimized Calgary Outdoors Page
 * 
 ...
 * 
 * Used as: Calgary Outdoors category page (/calgary/outdoors)
 */
...
import { getCityOutdoorsArticles } from '@/lib/data/city-category-data'
...
/**
 * Calgary Outdoors Page Component
 * 
 * Displays outdoors articles for Calgary
 */
export default async function CalgaryOutdoorsPage() {
  const articles = await getCityOutdoorsArticles('calgary')
            ...
            <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="flex flex-col items-center justify-center space-y-2 text-center">
                <div className="space-y-1">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-green-600">
                    Calgary Outdoors
                  </h1>
          ...
          <section className="w-full py-8">
            <div className="container mx-auto px-4 md:px-6">
              {articles.length > 0 ? (
                ...
                <EmptyState 
                  icon="🏔️"
                  title="No Outdoors Articles Found"
                  description="Check back later for new Calgary outdoors articles."
                />
              )}
            </div>
          </section>
