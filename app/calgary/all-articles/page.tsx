/**
 * Optimized Calgary All Articles Page
 * 
 ...
 * 
 * Used as: Calgary all articles page (/calgary/all-articles)
 */
              ...
              <div className="flex flex-col items-center justify-center space-y-2 text-center">
                <div className="space-y-1">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-red-600">
                    All Calgary Articles
                  </h1>
                  <p className="max-w-[900px] text-muted-foreground md:text-xl mx-auto">
                    Discover all {sortedArticles.length} articles about Calgary, Alberta's largest city.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="container mx-auto px-4 md:px-6">
              {sortedArticles.length > 0 ? (
                ...
                <EmptyState 
                  ...
                  description="Check back later for new Calgary articles."
                />
              )}
            </div>
          </section>
