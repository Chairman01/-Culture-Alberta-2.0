...
export const metadata: Metadata = {
  title: 'Food & Drink - Around Alberta - Culture Alberta',
      ...
      <main className="flex-1">
        <section className="w-full py-6 bg-amber-50">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl text-amber-800">Food & Drink</h1>
            <p className="mt-2 text-muted-foreground md:text-xl">Culinary stories from across Alberta</p>
          </div>
        </section>
