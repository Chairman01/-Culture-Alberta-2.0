...
export default async function RedDeerPage() {
    const { articles, featuredArticle, trendingArticles, topStories, foodDrinkArticles, cultureArticles, sportsArticles, realEstateArticles, crimeArticles, politicsArticles } = await getRedDeerData()
                                ...
                                <TabsContent key={value} value={value} className="mt-4">
                                    {items.length > 0 ? (
                                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                            {items.map((article: RedDeerArticle) => (
