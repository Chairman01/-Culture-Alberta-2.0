 ...
 * 
 * Used as: Edmonton city page route (/edmonton)
 */
...
import { formatRelativeDate, formatEventDate } from '@/lib/utils/date'
...
/**
 * Edmonton City Page Component
 * 
 * Displays Edmonton-specific articles, events, and content
 * 
 * Performance:
...
export default async function EdmontonPage() {
  const { articles, featuredArticle, trendingArticles, upcomingEvents } = await getCityPageData('edmonton')
    ...
    <>
      ...
      <div className="flex min-h-screen flex-col">
        <main className="flex-1">
            ...
            <div className="container mx-auto px-4 md:px-6">
              <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
                ...
                <div className="space-y-6">
                  ...
                  {/* Upcoming Events */}
                  <EventsSidebar city="edmonton" events={upcomingEvents} />
            ...
            <div className="container mx-auto px-4 md:px-6">
              <Tabs defaultValue="all" className="w-full">
                ...
                <TabsContent value="all" className="mt-4">
                  ...
                  {articles.length > 3 && (
                    <ViewAllLink href="/edmonton/all-articles" count={articles.length} color="blue" />
                  )}
                </TabsContent>
                ...
                <TabsContent value="food" className="mt-4">
                  ...
                  {foodArticles.length > 0 && (
                    <ViewAllLink href="/edmonton/food-drink" count={foodArticles.length} color="blue" />
                  )}
                </TabsContent>
                ...
                <TabsContent value="arts" className="mt-4">
                  ...
                  {artsArticles.length > 0 && (
                    <ViewAllLink href="/edmonton/arts-culture" count={artsArticles.length} color="blue" />
                  )}
                </TabsContent>
                ...
                <TabsContent value="outdoors" className="mt-4">
                  ...
                  {outdoorsArticles.length > 0 && (
                    <ViewAllLink href="/edmonton/outdoors" count={outdoorsArticles.length} color="blue" />
                  )}
                </TabsContent>
              </Tabs>
            </div>
          ...
          <NeighborhoodsSection articles={neighborhoodArticles} city="edmonton" />

          {/* Guides Section */}
          <GuidesSection articles={guideArticles} city="edmonton" />
        </main>
      </div>
    </>
  )
      ...
      <Link href={getArticleUrl(article)} className="group block">
        ...
        <div className="mt-3">
          <div className="flex items-center gap-2 mb-2">
            <span className="bg-blue-500 text-white px-2 py-1 text-xs rounded">Featured</span>
          ...
          <h2 className="text-2xl font-bold leading-tight tracking-tighter md:text-3xl lg:text-4xl group-hover:text-blue-600 transition-colors">
