...
export default async function MedicineHatPage() {
    const { articles, featuredArticle, trendingArticles, topStories, foodDrinkArticles, cultureArticles, sportsArticles, realEstateArticles, crimeArticles, politicsArticles } = await getMedicineHatData()
