    ...
    <div className="min-h-screen bg-background">
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Link in Bio</CardTitle>
              <Pin className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">Pin &amp; Order</div>
              <p className="text-xs text-muted-foreground">
                Choose which articles appear first on your link-in-bio page
              </p>
              <Button asChild className="mt-4" size="sm" variant="outline">
                <Link href="/admin/link-in-bio">Manage Link in Bio</Link>
              </Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">By City</div>
              <p className="text-xs text-muted-foreground">
                See registered members grouped and sorted by their city
              </p>
              <Button asChild className="mt-4" size="sm" variant="outline">
                <Link href="/admin/users">View Members by City</Link>
              </Button>
            </CardContent>
          </Card>
